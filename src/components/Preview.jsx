...
function getButtonStyle(S) {
  ...
  if (S.btnType === "solid")
    return {
      ...
      background: S.btn,
      color: S.bg,
      border: `2px solid ${S.btn}`,
      boxShadow: S.btnShadow.includes("currentColor")
        ? S.btnShadow.replace("currentColor", S.btn)
        : S.btnShadow,
    };
  if (S.btnType === "ghost")
    return {
  ...
  if (S.btnType === "neon")
    return {
      ...
      color: S.accent,
      border: `2px solid ${S.accent}`,
      boxShadow: `0 0 16px ${S.accent}50, inset 0 0 16px ${S.accent}15`,
    };
  if (S.btnType === "link")
    return {
      ...base,
  ...
  if (S.btnType === "raised")
    return {
      ...
      color: S.bg,
      border: "none",
      borderBottom: `4px solid ${darken(S.btn)}`,
      boxShadow: "none",
    };
  return base;
}
...
export default function Preview({ S }) {
  ...
  const cardStyle = {
    ...
    boxShadow: S.cardShadow.includes("currentColor")
      ? S.cardShadow.replace("currentColor", S.accent)
      : S.cardShadow,
    border: cardBorder,
    transition: `all ${S.transSpeed}`,
    padding: `${S.pad}rem`,
  ...
  const previewClasses = [S.liftOn ? "lift-on" : "", S.glowOn ? "glow-on" : ""]
    .filter(Boolean)
    .join(" ");
  ...
  return (
    <div
      ...
      style={{
        ...
        scrollbarWidth: "thin",
        padding: isMobile
          ? `${Math.max(S.pvpad * 0.6, 0.8)}rem`
          : `${S.pvpad}rem`,
        display: "flex",
        flexDirection: "column",
        gap: isMobile ? `${Math.max(S.gap * 0.75, 0.8)}rem` : `${S.gap}rem`,
        fontSize: `${S.baseSize}px`,
    ...
    >
      ...
      <div>
        ...
        >
          ...
          >
            <img
              ...
              className={`transition-all duration-300 ease-in-out ${
                S.bg && parseInt(S.bg.replace("#", ""), 16) < 0x444444
                  ? "invert brightness-105"
                  : ""
              }`}
            />
            Themic.
          ...
          {/* CTA button — always visible but compact on mobile */}
          <button
            style={{
              ...btnStyle,
              ...(isMobile
                ? { padding: "0.5rem 1rem", fontSize: "0.62rem" }
                : {}),
            }}
          >
      ...
      <div>
        ...
        >
          We craft interfaces that breathe — where motion has purpose, type has
          soul, and every detail earns its place.
        </p>
        <div
          style={{
            display: "flex",
        ...
        >
          <button className="pv-btn-1" style={btnStyle}>
            Start Project
          </button>
        ...
        >
          {[
            [
              "◈",
              "Interaction Design",
              "Every hover, every click, crafted with intention and delight.",
            ],
            [
              "✦",
              "Visual Systems",
              "Cohesive design languages that scale and breathe across products.",
            ],
            [
              "⬡",
              "Motion & Feel",
              "Animation that communicates meaning, not just movement.",
            ],
          ].map(([icon, title, body]) => (
      ...
      <div>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 6 }}>
          {["Branding", "UI Design", "Motion", "Typography", "Systems"].map(
            (tag, i) => (
              <div
                key={tag}
                style={{
                  ...
                  transition: `all ${S.transSpeed}`,
                  borderRadius:
                    S.btnRadius === "100px" ? "100px" : S.cardRadius,
                  ...(i % 2 === 0
                    ? {
                        background: hexBlend(S.bg, S.accent, 0.18),
                        color: S.accent,
                    ...
                    : {
                        background: "transparent",
                        color: S.text,
                        border: `1px solid ${hexBlend(S.bg, S.text, 0.18)}`,
                        opacity: 0.7,
                      }),
                }}
              >
      ...
      <div>
        ...
        <div
          style={{
            ...
            gap: "0.8rem",
            maxWidth: isMobile ? "100%" : 340,
            background: hexBlend(S.bg, S.text, 0.07),
            borderRadius: S.cardRadius,
            border: `1px solid ${hexBlend(S.bg, S.text, 0.14)}`,
            transition: `all ${S.transSpeed}`,
          }}
        >
          ...
          <div
            style={{
              ...
              opacity: 0.6,
              color: S.text,
              paddingLeft: isMobile ? 0 : "0.25rem",
            }}
          >
            Made by Abdullah Arif
          </div>
        </div>
      </div>
    </div>
